    ...
    <div class="page-container py-4 space-y-1">
            ...
            <div class="pt-4 border-t border-white/5">
                <div class="flex items-center justify-between px-4 py-2">
                    <span class="text-xs font-bold text-gray-400 uppercase tracking-widest">Warna Tema</span>
                    <button @click="toggleTheme()" 
                            class="relative w-12 h-6 rounded-full bg-white/5 border border-white/10 p-1 flex items-center transition-all duration-500 overflow-hidden">
                        <div class="w-4 h-4 rounded-full shadow-lg transition-all duration-500 flex items-center justify-center relative z-10"
                             :class="darkMode ? 'translate-x-6 bg-primary-600' : 'translate-x-0 bg-amber-500'">
                            <svg x-show="!darkMode" class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 3v1m0 16v1m9-9h-1M4 12H3m12 8a4 4 0 100-8 4 4 0 000-8z"/></svg>
                            <svg x-show="darkMode" class="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>
                        </div>
                    </button>
                </div>
            </div>
