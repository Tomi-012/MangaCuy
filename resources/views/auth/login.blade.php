...
<div class="min-h-[80vh] flex items-center justify-center px-4">
    <div class="w-full max-w-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="bg-dark-900/50 border border-dark-800 rounded-2xl p-8 space-y-5">
            @csrf
            ...
            <div class="flex items-center justify-between text-sm">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="remember" class="rounded border-dark-600 bg-dark-800 text-primary-600 focus:ring-primary-500">
